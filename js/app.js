...
class App {
  constructor() {
    ...
    this.baziEngine = null;
    this.ichingEngine = null;
    this.qimenEngine = null;
  ...
  async _loadEngines() {
    ...
    this.qimenEngine = new QimenEngine();
  ...
  async _performCalculation(formData) {
    ...
    const todayHours = await this._calculateDayHours(baziResult, today);
    const tomorrowHours = await this._calculateDayHours(baziResult, tomorrow);
